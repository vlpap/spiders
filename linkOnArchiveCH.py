...
producer.send('test2', str.encode(joinUrls('http://download.companieshouse.gov.uk/en_output.html')), str.encode(joinUrls('http://download.companieshouse.gov.uk/en_output.html')))
